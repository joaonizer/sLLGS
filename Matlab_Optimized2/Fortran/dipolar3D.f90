...
MODULE precision_def
	...
	REAL(lg),PARAMETER :: zero=0._lg,half=0.5_lg,one=1._lg,tres=3._lg
...
MODULE ab
	USE precision_def
	IMPLICIT NONE
	REAL(lg)  :: au_i,bu_i,ad_i,bd_i
	REAL(lg)  :: au_j,bu_j,ad_j,bd_j
END MODULE ab
...
PROGRAM dipolar3D
	...
	IMPLICIT NONE
  	REAL(lg)	:: ints(7)
	REAL(lg)  	:: px_i(4), py_i(4)
	REAL(lg)  	:: px_j(4), py_j(4)
...
END PROGRAM dipolar3D
	...
	REAL(lg),INTENT(OUT) :: int0(7)
	REAL(lg) :: x_i(3), x_j(3)
	REAL(lg) :: f0(7), int_ij(7)
	REAL(lg) :: vi, ymin_i, ymax_i
	REAL(lg) :: vj, ymin_j, ymax_j
	INTEGER  :: i0
...
!		VOLUME j
	...
	CONTAINS
		...
		USE precision_def
		IMPLICIT NONE
		REAL(lg),INTENT(OUT) :: x_0i(3), ymin0i, ymax0i
		...
		USE precision_def
		IMPLICIT NONE
		REAL(lg),INTENT(OUT) :: x_0j(3), ymin0j, ymax0j
		...
		USE precision_def
		IMPLICIT NONE
		REAL(lg),INTENT(IN)  :: x0_i(3),x0_j(3)
		REAL(lg),INTENT(OUT) :: int_0(7)
		REAL(lg)	     :: eta,csi,kap
		REAL(lg)	     :: eta2,csi2,kap2
		REAL(lg)	     :: den1,den2
