...
MODULE precision_def
	...
	!REAL*8,PARAMETER :: zero=0._lg,half=0.5_lg,one=1._lg,tres=3._lg
	REAL*8,PARAMETER :: zero=0.0,half=0.5,one=1.0,tres=3.0
...
PROGRAM dipolar3D3_noDAT_NMC
	...
	integer :: array_size
  	REAL*8	:: ints(7)
	REAL*8  	:: px_i(4), py_i(4)
	REAL*8  	:: px_j(4), py_j(4)
	
	INTERFACE
	
		SUBROUTINE MC_dipolar(nmc, int0)
		USE precision_def
		USE dimensions_particles
		USE positions_particles
		USE ab
...
100	FORMAT(E13.4,E13.4,E13.4)
	...
	READ(*,*)px_i(1),py_i(1), px_i(2),py_i(2), px_i(3),py_i(3), px_i(4),py_i(4), t_i, xyz0_i(1),xyz0_i(2),xyz0_i(3), px_j(1),py_j(1), px_j(2),py_j(2), px_j(3),py_j(3), px_j(4),py_j(4), t_j, xyz0_j(1),xyz0_j(2),xyz0_j(3),nmc,rnd_seed
	...
	WRITE(*,*) &
	ints(1)-tres*ints(2),-tres*ints(5),-tres*ints(6), -tres*ints(5), ints(1) -tres*ints(3),-tres*ints(7), -tres*ints(6), -tres*ints(7), ints(1) -tres*ints(4) 



END PROGRAM dipolar3D3_noDAT_NMC
