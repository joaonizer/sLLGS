function [Nc, V]=write_FileDipolar3D_noDAT(px, py, th, d_or, platform)
...
data_p=[
    ...
    num2str(th(2)) ' '...
    num2str(d_or(2,1)) ' ' num2str(d_or(2,2)) ' ' num2str(d_or(2,3))
    ];
%% Calcula os parametros pelo .exe
if strcmp(platform,'lin')
    [flag,Nstr]=system(['echo '' ' data_p ' '' | ./Fortran/dipolar3D3_noDAT']); % roda o executavel
    
else
    [flag,Nstr]=system(['echo ' data_p ' | .\Fortran\dipolar3D3_noDAT.exe']);
end
