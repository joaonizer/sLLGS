...
th=ones(1,part_n)*20;   %thickness of particles
...
dx=(w(1)+10)*[0:50]; %% deslocamentos em x
...
d_or([11],2)=d_or([11],2)-20;
d_or([6 10 14 17 20],2)=d_or([6 10 14 17 20],2)-45;
d_or([9],2)=d_or([9],2)-70;
d_or([1 3 5 8 13 16 19],2)=d_or([1 3 5 8 13 16 19],2)-95;
th([9 11])=15;
th([6 10])=10;
...
for i=1:part_n
    ...
    if (sum(i==[1 2 6])) % X in
        ...
        s=      [
            ...
            %             a   0   0   0   0   0   N/phases %1
            ];
    elseif (sum(i==[3 4 5 7 8 12]))
        cor(i,:)=colors(2,:);
        s=      [
...
th_shm = 10; % [nm] espessura do material pesado
