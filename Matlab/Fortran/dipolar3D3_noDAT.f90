...
100	FORMAT(E13.4,E13.4,E13.4)
	...
	READ(*,*)px_i(1),py_i(1), px_i(2),py_i(2), px_i(3),py_i(3), px_i(4),py_i(4), t_i, xyz0_i(1),xyz0_i(2),xyz0_i(3), px_j(1),py_j(1), px_j(2),py_j(2), px_j(3),py_j(3), px_j(4),py_j(4), t_j, xyz0_j(1),xyz0_j(2),xyz0_j(3)
