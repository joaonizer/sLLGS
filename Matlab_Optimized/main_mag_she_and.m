...
for jj=1:4
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ex=0.1*experiment(jj,:); % testa a primeira combina̤̣o de 8 possibilidades
    name=['test_and-' num2str(experiment(jj,1)) num2str(experiment(jj,2)) '_' num2str(T) 'K-' num2str(N) 'steps-' num2str(tempo_total*1e9) 'ns-' num2str(alpha*100) 'alpha-force-module'];
    ...
    for i=1:part_n
        ...
        if (i==1) % X in
            cor(i,:)=colors(1,:);
            s=      [
                0   ex(1)*a   0   a   ex(1)*a   0   N/phases %2
                a   ex(1)*a   0   a   ex(1)*a   0   N/phases %2
                a   ex(1)*a   0   0   ex(1)*a   0   N/phases %2
                0   ex(1)*a   0   0   ex(1)*a   0   N/phases %2
        ...
        elseif (i==2) % Ybar in
            cor(i,:)=colors(1,:);
            s=      [
                0   ex(2)*a   0   a   ex(2)*a   0   N/phases %2
                a   ex(2)*a   0   a   ex(2)*a   0   N/phases %2
                a   ex(2)*a   0   0   ex(2)*a   0   N/phases %2
                0   ex(2)*a   0   0   ex(2)*a   0   N/phases %2
                0   0   0   0   0   0   N/phases %6
                0   0   0   0   0   0   N/phases %6
                ];
        ...
        elseif i==400 %Y in
            cor(i,:)=colors(1,:);
            s=      [
                0   ex(2)*a   0   a   ex(2)*a   0   N/phases %1
                a   ex(2)*a   0   a   ex(2)*a   0   N/phases %2
                a   ex(2)*a   0   0   ex(2)*a   0   N/phases %3
                0   ex(2)*a   0   0   ex(2)*a   0   N/phases %4
                0   0   0   0   0   0   N/phases %5
                0   0   0   0   0   0   N/phases %6
                ];
        elseif (sum(i==[3 4 5 6]))
            cor(i,:)=colors(1,:);
            s=      [
...
J_shm=10*140e9; % Spin Hall current density (A/m2)
